  ...
  const handleSignIn = async (e) => {
    ...
    try {
      ...
      if (error.error === "Invalid credentials") {
        ...
        setActivate(false);
        setInvalid(true);
      } else if (error.error === "Not verified By the Administrator") {
        setInvalid(false);
        setActivate(false);
        setVerifiedAdmin(true);
      } else if (
        error.error === "Your Account Not Approuved By The Administrator"
      ) {
        setInvalid(false);
        setActivate(false);
        setVerifiedAdmin(false);
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
                ...
                {invalid && (
                  <p className="text-danger text-center font-semibold text-sm mt-2 mb-2">
                ...
                {verifiedAdmin && (
                  <p className="text-danger text-center font-semibold text-sm mt-2 mb-2">
                    Your Account Still Not Verified By The Administrator
                  </p>
                )}
                {AccountRejected && (
                  <p className="text-danger text-center font-semibold text-sm mt-2 mb-2">
                    Your Account Not Approuved By The Administrator
                  </p>
                )}
