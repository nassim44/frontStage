...
const SignupPage = () => {
  ...
  useEffect(() => setUser({ ...User, roles: role }), [role]);
  const [image, setImage] = useState();
  const handleChange = (e) => {
    const value =
      e.target.name === "Tel" ? parseInt(e.target.value) : e.target.value;
  ...
  const handleSubmitSignup = async (e) => {
    ...
    fileReader.onloadend = async function () {
      ...
      try {
        console.log(User);
        const response = await signup(imageData);
        ...
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4">
              <div className="mx-auto max-w-[600px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
